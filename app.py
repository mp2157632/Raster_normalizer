...
def normalize():
    ...
    try:
        ...
        if normalized.ndim == 3 and normalized.shape[0] <= 4:

            preview_data = normalized

            if preview_data.shape[0] == 1:
                preview = preview_data[0]

            elif preview_data.shape[0] >= 3:
                preview = np.transpose(
                    preview_data[:3],
                    (1, 2, 0)
                )
